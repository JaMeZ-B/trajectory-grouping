...
\begin{frame}{Was zeichnet eine kollektive Bewegung aus?}
    \begin{tabular}{rp{8cm}c}
        \hiddencell{2}{\bet{Räumliche Nähe} & Die einzelnen Entitäten dürfen nicht zu weit voneinander entfernt sein} & \hiddencell{5}{$\varepsilon>0$}\\
...
\begin{frame}{Komplexität des Reeb-Graphen}
    ...
    \begin{columns}
        ...
        \centering
        \uncover<4->{\begin{tikzpicture}[scale=.25,>=Latex,font=\small]
