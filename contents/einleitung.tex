...
Diese Eigenschaft des hier vorgestellten Modells ist einer der Aspekte, aufgrund derer dieses Modell anderen Modellen zur Gruppierung von Trajektorien überlegen ist; dazu mehr in \cref{cha:related_work}.\todo{Liste der Vorteile aus Vortrag}
