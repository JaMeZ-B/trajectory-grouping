...
Diese Monotonie-Eigenschaften haben zur Folge, dass bei einer detaillierten Betrachtung durch Verringerung der Parameter $\delta$ und $m$ die maximalen Gruppen erhalten bleiben.
\todo{was dazu in dem Paper bzgl der Größe und Dauer steht, halte ich für falsch}
...
Man möchte die Gruppen also \Index{robust} gegenüber kleinen Störungen machen, die insbesondere bei Daten aus der Praxis durchgängig auftreten.
