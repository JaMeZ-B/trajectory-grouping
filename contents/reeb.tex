...
\begin{beweis}
	...
	\begin{figure}[bthp]
		...
		\end{tikzpicture}
		\caption{Konstruktion der unteren Schranke für die Anzahl maximaler Gruppen für $n=39$ zum Zeitpunkt $j_2$.}\label{fig:zinnen}
	\end{figure}
	...
	\begin{figure}[hbtp]
		\Centering
		\missingfigure{Figure 6 aus Paper übernehmen}
